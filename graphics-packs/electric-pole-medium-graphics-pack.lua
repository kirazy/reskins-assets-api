...
---@class ElectricPoleMediumGraphicsPack:ElectricPoleGraphicsPack
...
---@class ElectricPoleMediumGraphicsParams
---@field tint data.Color?

---@param params ElectricPoleMediumGraphicsParams
...
function ElectricPoleMediumGraphicsPack:configure(params)
	...
	}) --[[@as ElectricPoleMediumGraphicsPack]]
