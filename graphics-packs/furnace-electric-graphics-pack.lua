...
---@class FurnaceElectricGraphicsPack:CraftingMachineGraphicsPack
...
---@class FurnaceElectricGraphicsParams
...
---@param params FurnaceElectricGraphicsParams
...
function FurnaceElectricGraphicsPack:configure(params)
	...
	}) --[[@as FurnaceElectricGraphicsPack]]
