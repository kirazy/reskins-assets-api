...
---@class AccumulatorGraphicsPack:GraphicsPackBase
...
---@alias AccumulatorSpriteSet
---| "base"
---| "fast"
---| "high-capacity"
---| "slow"

---@class AccumulatorGraphicsParams
---@field tint data.Color?
---@field sprite_set AccumulatorSpriteSet?

---@param params AccumulatorGraphicsParams
...
---@param sprite_set AccumulatorSpriteSet?
...
---@param sprite_set AccumulatorSpriteSet? # Default "base".
