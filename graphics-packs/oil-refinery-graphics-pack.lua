...
---@class OilRefineryGraphicsPack:CraftingMachineGraphicsPack
...
---@class OilRefineryGraphicsParams
---@field tint data.Color?

---@param params OilRefineryGraphicsParams
