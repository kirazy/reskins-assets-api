...
---@class Reskins.Angels.ChemicalFurnaceGraphicsPackParams
---@field tint data.Color?

---@param params Reskins.Angels.ChemicalFurnaceGraphicsPackParams
...
function ChemicalFurnaceGraphicsPack:apply_to_entity(prototype)
