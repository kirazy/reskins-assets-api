...
---@class InductionFurnaceGraphicsPack:CraftingMachineGraphicsPack
...
function InductionFurnaceGraphicsPack:configure(params)
	...
	}) --[[@as InductionFurnaceGraphicsPack]]
