...
---@class ChemicalPlantGraphicsPack:CraftingMachineGraphicsPack
...
---@class ChemicalPlantGraphicsParams
---@field tint data.Color?

---@param params ChemicalPlantGraphicsParams
