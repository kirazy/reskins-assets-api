...
---@class GeneratorGraphicsPack:GraphicsPackBase
...
---@class GeneratorGraphicsParams:GraphicsPackParams
---@field horizontal_animation data.Animation
---@field vertical_animation data.Animation

---@param params GeneratorGraphicsParams
