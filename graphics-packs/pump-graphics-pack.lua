...
---@class PumpGraphicsPack:GraphicsPackBase
---@field animations data.PumpAnimations
...
---@class PumpGraphicsParams
---@field tint data.Color?

---@param params PumpGraphicsParams
