...
---@class ElectricPoleBigGraphicsPack:ElectricPoleGraphicsPack
...
---@class ElectricPoleBigGraphicsParams
---@field tint data.Color?

---@param params ElectricPoleBigGraphicsParams
...
function ElectricPoleBigGraphicsPack:configure(params)
	...
	}) --[[@as ElectricPoleBigGraphicsPack]]
