...
---Gets the icon for a stone furnace of the `variant` and in the tints given by `params`.
M.get_icon = IconCatalog.dispatch("variant", { "standard", "chemical" }, "get_icon", function(variant)
