...
---
---local sprite_set = mining_drill_electric.get_sprite_set({ tint = tint })
...
---Gets the icon for the vanilla electric mining drill, in the given `tint`.
...
function M.get_icon(tint)
	...
	local folder = "__reskins-assets-base__/graphics/icons/mining-drill-electric/mining-drill-electric-icon-"
