...
---@class AdvancedChemicalPlantSpriteSetParams
---The color to tint the artwork. When `nil`, the tintable layers are omitted from the set.
---@field tint Color?

---Gets the sprite set for Angel's advanced chemical plant.
---@param params AdvancedChemicalPlantSpriteSetParams The options the sprite set is drawn with.
---@return SpriteSetDefinition<CraftingMachineSpriteSet>
---
---#### Examples
---```lua
---local advanced_chemical_plant = require("__reskins-assets-api__.assets.angels.entities.petrochem.advanced-chemical-plant")
---local applicators = require("__reskins-assets-api__.api.applicators")
---
---local sprite_set = advanced_chemical_plant.get_sprite_set({ tint = tint })
...
---Gets the icon for Angel's advanced chemical plant, in the given `tint`.
...
function M.get_icon(tint)
	...
	local folder = "__reskins-assets-angels__/graphics/icons/chemical-plant-advanced/chemical-plant-advanced-icon-"
