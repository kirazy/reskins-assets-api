...
---Gets the sprite set for Angel's air filter.
---@param params AirFilterSpriteSetParams # The options the sprite set is drawn with.
---@return SpriteSetDefinition<CraftingMachineSpriteSet>
---
---### Examples
---```lua
---local air_filter = require("__reskins-assets-api__.assets.angels.entities.petrochem.air-filter")
---local applicators = require("__reskins-assets-api__.api.applicators")
---
---local sprite_set = air_filter.get_sprite_set({ tint = tint })
...
---Gets the icon for Angel's air filter, in the given `tint`.
...
function M.get_icon(tint)
	...
	local folder = "__reskins-assets-angels__/graphics/icons/air-filter/air-filter-icon-"
