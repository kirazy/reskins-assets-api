...
---
---local sprite_set = steam_cracker.get_sprite_set({ tint = tint })
...
---Gets the icon for Angel's steam cracker, in the given `tint`.
...
function M.get_icon(tint)
	...
	local folder = "__reskins-assets-angels__/graphics/icons/steam-cracker/steam-cracker-icon-"
