...
---Gets the icon for Angel's induction furnace, in the given `tint`.
...
function M.get_icon(tint)
	...
	local folder = "__reskins-assets-angels__/graphics/icons/induction-furnace/induction-furnace-icon-"
