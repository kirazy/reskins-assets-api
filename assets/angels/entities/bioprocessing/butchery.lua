...
---Gets the sprite set for Angel's butchery.
---@param params ButcherySpriteSetParams # The options the sprite set is drawn with.
---@return SpriteSetDefinition<CraftingMachineSpriteSet>
---
---### Examples
---```lua
---local butchery = require("__reskins-assets-api__.assets.angels.entities.bioprocessing.butchery")
---local applicators = require("__reskins-assets-api__.api.applicators")
---
---local sprite_set = butchery.get_sprite_set({ tint = tint })
...
---Gets the icon for Angel's butchery, in the given `tint`.
...
function M.get_icon(tint)
	...
	local folder = "__reskins-assets-angels__/graphics/icons/butchery/butchery-icon-"
