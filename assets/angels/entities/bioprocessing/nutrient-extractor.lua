...
---Gets the icon for Angel's nutrient extractor, in the given `tint`.
...
function M.get_icon(tint)
	...
	local folder = "__reskins-assets-angels__/graphics/icons/nutrient-extractor/nutrient-extractor-icon-"
