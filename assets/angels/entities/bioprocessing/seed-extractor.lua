...
---
---local sprite_set = seed_extractor.get_sprite_set({ tint = tint })
...
---Gets the icon for Angel's seed extractor, in the tints given by `params`.
M.get_icon = icons:tinted("seed-extractor"):build("get_icon")
