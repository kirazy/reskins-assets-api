...
---Gets the icon for Angel's ore sorting facility, in the given `tint`.
...
function M.get_icon(tint)
	...
	local folder = "__reskins-assets-angels__/graphics/icons/ore-sorting-facility/ore-sorting-facility-icon-"
