...
---Gets the sprite set for Angel's ore crusher.
---@param params OreCrusherSpriteSetParams # The options the sprite set is drawn with.
---@return SpriteSetDefinition<CraftingMachineSpriteSet>
---
---### Examples
---```lua
---local ore_crusher = require("__reskins-assets-api__.assets.angels.entities.refining.ore-crusher")
---local applicators = require("__reskins-assets-api__.api.applicators")
---
---local sprite_set = ore_crusher.get_sprite_set({ tint = tint })
...
---Gets the icon for Angel's ore crusher, in the given `tint`.
...
function M.get_icon(tint)
	...
	local folder = "__reskins-assets-angels__/graphics/icons/ore-crusher/ore-crusher-icon-"
